...
const DecoratorBlob1 = styled(SvgDecoratorBlob1)`
  ${tw`pointer-events-none opacity-5 absolute left-0 bottom-0 h-64 w-64 transform -translate-x-2/3  -z-10 fill-current text-gray-700`}
`;
const DecoratorBlob2 = styled(SvgDecoratorBlob2)`
  ${tw`pointer-events-none fill-current text-blue-700 opacity-25 absolute w-32 h-32 right-0 bottom-0 transform translate-x-10 translate-y-10 -z-10`}
`;
...
const StyledModal = styled(ReactModalAdapter)`
  ...
  &.mainHeroModal__content {
    ${tw`xl:mx-auto m-4 sm:m-16 max-w-screen-xl absolute inset-0 flex justify-center items-center rounded-lg bg-gray-800 outline-none`}
  }
  .content {
    ${tw`w-full lg:p-16`}
  }
...
export default ({
  heading = 'Welcome to Our Tech Hub',
  description = 'We provide cutting-edge solutions for all your tech needs, fast and efficient.',
  primaryButtonText = 'Get Started',
  primaryButtonUrl = '/products',
  watchVideoButtonText = 'Watch Video',
  watchVideoYoutubeUrl = 'https://www.youtube.com/embed/6aia42zBHhc?si=jLxeauawy9fblTa3&amp;start=3',
        ...
        <TwoColumn>
          ...
          <RightColumn>
            <IllustrationContainer>
              <img css={imageCss} src={imageSrc} alt="Tech Illustration" />
