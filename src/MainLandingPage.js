...
export default ({
  ...
  heading = "Trendera - Your One-Stop Shop for All Your Needs.",
  description = "Trendera is a platform that provides a wide range of products and services for individuals and businesses."
}) => {
  /*
